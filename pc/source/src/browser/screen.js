...
function ScreenAdapter(screen_container, bus)
{
	...
	var save_as_block=0;
    // 0x12345 -> "#012345"
    function number_as_color(n, is_bg)
    {
        n = n.toString(16);
		var result="#" + Array(7 - n.length).join("0") + n;
		if(is_bg)
		{
		...
		{
			if(result=="#aaaaff")result=document.getElementById("fg_down").value;
			else if(result=="#0000aa")result=document.getElementById("fg_blue").value;
			else if(result=="#000000")result=document.getElementById("fg_black").value;
			else if(result=="#aaaaaa")result=document.getElementById("fg_gr").value;
	...
	{
		if(text=="   File  Edit  View  Search  Run  Debug  Options                          Help  " || text=="  File  Edit  View  Search  Run  Debug  Options                          Help  ")
		{
			if(text=="   File  Edit  View  Search  Run  Debug  Options                          Help  ")text="";
    ...
    //cursor_element.style.height = "14px";
    ...
    this.text_update_row = function(row)
    {
        ...
        for(var i = 0; i < text_mode_width; )
        {
            ...
            color_element.style.backgroundColor = number_as_color(bg_color, true);
            color_element.style.color = number_as_color(fg_color, false);

            text = "";
			
			//console.log(number_as_color(fg_color, false) + number_as_color(bg_color, true));
            ...
            color_element.textContent = scan_text(text);
